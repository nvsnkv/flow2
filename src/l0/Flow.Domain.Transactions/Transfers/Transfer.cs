...
{
    public Transfer(long source, long sink, decimal fee, string currency, DetectionAccuracy accuracyLevel):base(source, sink)
    {
    ...
    public Transfer(RecordedTransaction source, RecordedTransaction sink, DetectionAccuracy accuracyLevel) : base(source.Key, sink.Key)
    {
