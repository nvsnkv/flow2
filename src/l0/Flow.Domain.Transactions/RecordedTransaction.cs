...
namespace Flow.Domain.Transactions
{
    ...
    {
        public RecordedTransaction(long key, decimal amount, string currency, string? category, string title, AccountInfo account) : base(amount, currency, category, title, account)
        {
            Key = key;
        }
