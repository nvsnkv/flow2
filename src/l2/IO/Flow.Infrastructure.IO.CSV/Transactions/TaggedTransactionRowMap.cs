...
[UsedImplicitly]
internal sealed class TaggedTransactionRowMap : ClassMap<TaggedTransactionRow>
{
    public TaggedTransactionRowMap()
    {
        Map(m => m.KEY).Index(0);
        ...
        Map(m => m.REVISION).Index(12);
        Map(m => m.TAGS).Index(11);
    }
