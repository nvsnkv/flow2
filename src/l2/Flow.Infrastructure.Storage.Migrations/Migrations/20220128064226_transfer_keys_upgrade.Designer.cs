...
namespace Flow.Infrastructure.Storage.Migrations.Migrations
{
    ...
    [Migration("20220128064226_transfer_keys_upgrade")]
    partial class transfer_keys_upgrade
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flow.Infrastructure.Storage.Model.DbTransferKey", b =>
                {
                    b.Property<long>("SourceKey")
                        .HasColumnType("bigint");

                    b.Property<long>("SinkKey")
                        .HasColumnType("bigint");

                    b.HasKey("SourceKey", "SinkKey");
            ...
            modelBuilder.Entity("Flow.Infrastructure.Storage.Model.DbTransferKey", b =>
                {
                    b.HasOne("Flow.Infrastructure.Storage.Model.DbTransaction", "SinkTransaction")
                        .WithOne("SinkOf")
                        .HasForeignKey("Flow.Infrastructure.Storage.Model.DbTransferKey", "SinkKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Flow.Infrastructure.Storage.Model.DbTransaction", "SourceTransaction")
                        .WithOne("SourceOf")
                        .HasForeignKey("Flow.Infrastructure.Storage.Model.DbTransferKey", "SourceKey")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
